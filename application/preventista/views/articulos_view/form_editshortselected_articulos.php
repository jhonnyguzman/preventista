<div id="marcas">
	<form action="<?=base_url()?>articulos_controller/editFastSeleccion_c" method="post" name="formEditFastSeletedArticulos" id="formEditFastSeletedArticulos">
		...
		<div class="botonera">
			<input type="submit" name="actualizar" value="Actualizar" class="crudtest-button" id="btn-save" onClick="submitData('formEditFastSeletedArticulos',new Array('right-content','right-content'))"></input>
		</div>
	</form>
</div>
