	...
	<form action="<?=base_url()?>hojaruta_controller/evaluar_c/" method="post" name="formEvaluacionHojaRuta" id="formEvaluacionHojaRuta">
		...
		<div class="foodEvaluacion">
			...
			<div class="botoneraEvaluacion">
				<input type="submit" name="Registrar" value="Registrar" class="crudtest-button" onClick="submitData3('formEvaluacionHojaRuta','content_detail_modal', 300,500,'Resultado de evaluaci&oacute;n')"/>
			</div>
		</div>
	</form>
</div>
